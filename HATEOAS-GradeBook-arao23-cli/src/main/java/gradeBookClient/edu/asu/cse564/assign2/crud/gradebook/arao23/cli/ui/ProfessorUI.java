...
import gradeBookClient.edu.asu.cse564.assign2.crud.gradebook.arao23.cli.model.GradeItem2;
import gradeBookClient.edu.asu.cse564.assign2.crud.gradebook.arao23.cli.model.Link;
...
public class ProfessorUI extends javax.swing.JFrame {
    ...
    // Changes for ASSIGN 3
    private void hateosFlowCapture(String tag)
    {
        if(tag.equals("C"))
        {
            // Enable Create
            RADIO1_CREATE.setVisible(true);
            // Enable Update
            RADIO3_UPDATE.setVisible(true);
            // Enable Delete
            RADIO4_DELETE.setVisible(true);
            // Enable Read
            RADIO2_READ.setVisible(true);
        }
        else if (tag.equals("D"))
        {
            ...
            RADIO1_CREATE.setVisible(true);
            // Enable Update
            RADIO3_UPDATE.setVisible(false);
            // Enable Delete
            RADIO4_DELETE.setVisible(false);
            // Enable Read
            RADIO2_READ.setVisible(false);
        }
        else if (tag.equals("U"))
        {
            // Enable Create
            RADIO1_CREATE.setVisible(false);
            // Enable Update
            RADIO3_UPDATE.setVisible(true);
            // Enable Delete
            RADIO4_DELETE.setVisible(true);
    ...
    private void populateForm(ClientResponse clientResponse, String tag) {
        List<Link> resLinks ;
        if (ifButtonIsDel) {
            try {
                RESPONSE_TEXT.setText(Integer.toString(clientResponse.getStatus()));
                MEDIA_TYPE_TEXT.setText("application/xml");
                hateosFlowCapture(tag);
                URI_LOCATION_LBL.setText("CREATE: http://localhost:8080/HATEOAS-GradeBook-arao23-srv/webapi/webresources/grades/" + ID_STU_TEXT.getText());
                return;
            } catch (Exception e) {
                MEDIA_TYPE_TEXT.setText("application/xml");
                return;
        ...
        if (!ifButtonIsDel) {
            ...
            try {
                if ((clientResponse.getStatus() == Response.Status.OK.getStatusCode()) || (clientResponse.getStatus() == Response.Status.CREATED.getStatusCode())) {
                    GradeItem2 gra = (GradeItem2) Converter.convertFromXmlToObject(ent, GradeItem2.class);
                    //Student ID
                    ...
                    resLinks = (ArrayList) gra.getLinks();
                    StringBuilder sbuf = new StringBuilder();
                    for(Link curr : resLinks)
                    {
                        sbuf.append(curr.getRel().toUpperCase() + " : " + curr.getLink() + "\n");
                    }
                    URI_LOCATION_LBL.setText(sbuf.toString());
                    // Changes for ASSIGN 3
                    hateosFlowCapture(tag);
                } else {
                    ID_STU_TEXT.setText("");
        ...
        if (clientResponse.getStatus() == Response.Status.CREATED.getStatusCode()) {
            URI_LOCATION_LBL.setText(clientResponse.getLocation().toString());
        } else {
            URI_LOCATION_LBL.setText("");
        }*/
    }
    ...
    private void initComponents() {
        ...
        URI_LOCATION_LBL = new javax.swing.JTextArea();
        ...
        MAX_WT_LABEL.setForeground(new java.awt.Color(255, 51, 51));
        ...
        getContentPane().add(MAIN_BUTTON_SUBMIT, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 450, 100, 30));
        ...
        LOCATION_URI_LABEL.setText("Available Links");
        getContentPane().add(LOCATION_URI_LABEL, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, -1, 20));
        ...
        getContentPane().add(BUTTON1_BACK, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 450, 100, 30));

        URI_LOCATION_LBL.setColumns(20);
        URI_LOCATION_LBL.setRows(5);
        jScrollPane1.setViewportView(URI_LOCATION_LBL);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(126, 350, 490, 90));

        setSize(new java.awt.Dimension(675, 531));
    ...
    private void MAIN_BUTTON_SUBMITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MAIN_BUTTON_SUBMITActionPerformed
        ...
        if ((RADIO1_CREATE.isSelected() == true)) {
            ...
            this.populateForm(clientResponse,"C");
        }
        /* READ */
        if (RADIO2_READ.isSelected() == true) {
            ...
            this.populateForm(clientResponse,"R");
        }
        /* UPDATE */
        if (RADIO3_UPDATE.isSelected() == true) {
            ...
            resourceURI = clientResponse.getLocation();
            this.populateForm(clientResponse,"U");
        }
        /* DELETE */
        if ((RADIO4_DELETE.isSelected() == true)) {
            ...
            this.populateForm(clientResponse,"D");
        }
    ...
    private javax.swing.JTextArea URI_LOCATION_LBL;
